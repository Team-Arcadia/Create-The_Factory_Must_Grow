...
// The Flywheel visual was lost in the 1.21 port, and the fallback renderer
// stands down whenever Flywheel visualization is active, so the hose - coil,
// magnet and rope - was never drawn at all and the tip position could not be
// judged. Mirrors Create's HosePulleyVisual with the same hose partials the
// fallback renderer already uses.
