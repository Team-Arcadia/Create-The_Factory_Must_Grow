...
public class TFMGSequencedAssemblyRecipeGen extends SequencedAssemblyRecipeGen {
    ...
    STEEL_MECHANISM = create("steel_mechanism", b -> b.require(TFMGItems.HEAVY_PLATE)
            ...
            .addOutput(TFMGItems.STEEL_MECHANISM.get(), 0.8f)
            .addOutput(Items.IRON_NUGGET, 0.2f)
            .loops(1)
            .addStep(DeployerApplicationRecipe::new, rb -> rb.require(TFMGItems.STEEL_INGOT))
            .addStep(DeployerApplicationRecipe::new, rb -> rb.require(TFMGItems.ALUMINUM_INGOT))
