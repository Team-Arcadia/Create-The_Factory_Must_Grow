...
public class TFMGFillingRecipeGen extends FillingRecipeGen {
    ...
    GeneratedRecipe
            ...
            .require(net.minecraft.tags.ItemTags.create(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("c", "stripped_logs")))
    ...
    HYDROGEN_TANK = create(TFMG.asResource("hydrogen_tank"), b -> b
            ...
            FURNACE_GAS_TANK = create(TFMG.asResource("furnace_gas_tank"), b -> b
                    .require(Items.BUCKET)
                    .require(SizedFluidIngredient.of(blastFurnaceGas(), 1000))
            ...
            CARBON_DIOXIDE_TANK = create(TFMG.asResource("carbon_dioxide_tank"), b -> b
                    .require(Items.BUCKET)
                    .require(SizedFluidIngredient.of(carbonDioxide(), 1000))
            ...
            HOT_AIR_TANK = create(TFMG.asResource("hot_air_tank"), b -> b
                    .require(Items.BUCKET)
                    .require(SizedFluidIngredient.of(hotAir(), 1000))
                    .output(hotAirTank())
            ),
